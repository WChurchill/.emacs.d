...
(custom-theme-set-faces
 ...
 '(font-lock-function-name-face ((t (:foreground "mediumspringgreen" :underline t))))
 '(font-lock-keyword-face ((t (:foreground "orange" :bold nil))))
 '(font-lock-preprocessor-face ((t (:foreground "magenta4"))))
 '(font-lock-reference-face ((t (:foreground "white"))))
 '(font-lock-string-face ((t (:foreground "yellow3"))))
 '(font-lock-type-face ((t (:foreground "Violetred"))))
