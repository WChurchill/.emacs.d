...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#00ff00" :bold nil))))
 '(font-lock-comment-face ((t (:foreground "gray55"))))
 '(font-lock-constant-face ((t (:foreground "#aa55ff")))) ;; deep purple
 '(font-lock-doc-face ((t (:foreground "#55aaaa")))) ;; blue-green
 '(font-lock-doc-string-face ((t (:foreground "#aaff00"))))
 '(font-lock-function-name-face ((t (:foreground "royalblue" :bold nil))))
 '(font-lock-keyword-face ((t (:foreground "#55aa00" :bold nil))))
 '(font-lock-preprocessor-face ((t (:foreground  "dodger blue" ))))
 '(font-lock-reference-face ((t (:foreground "#558055"))))
 '(font-lock-string-face ((t (:foreground "lightgreen")))) ;; dark green
 '(font-lock-type-face ((t (:foreground "#ffffff" :bold nil ))))
