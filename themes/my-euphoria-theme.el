...
(custom-theme-set-faces
 ...
 '(font-lock-function-name-face ((t (:foreground "SteelBlue" :bold nil))))
 ...
 '(font-lock-string-face ((t (:foreground "springgreen3" :bold t))))
 '(font-lock-type-face ((t (:foreground "DarkCyan" :bold nil))))
 '(font-lock-variable-name-face ((t (:foreground "blue2" :bold t))))
